...
/**
 * Processes the manifest.ttl files of the Microdata test suite and extracts the
 * pairs of HTML and TTL files of all tests.
 *
 * @author Michael Röder (michael.roeder@uni-paderborn.de)
 * @author Thoren Grüttemeier (thoreng@uni-paderborn.de, Microdata modifications)
 *
 */
